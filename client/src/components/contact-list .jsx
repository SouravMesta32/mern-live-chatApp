...
const ContactList = ({contacts , isChannel = false}) => {
  ...
  return (
    <div className="mt-5">
        {contacts.map(contact=> <div key={contact._id} className={`pl-10 pb-1 pt-2 transition-all duration-300 cursor-pointer ${SelectedChatData && SelectedChatData._id === contact._id ? "bg-[#8417ff] hover:bg-[#8417ff]" : "hover:bg-[#f1f1f111]"} border-b-black border-b rounded-lg `} onClick={()=>handleClick(contact)}>
